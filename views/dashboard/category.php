                    ...
                    <div class="modal-content">
                        ...
                        <form action="/add_category" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" onclick="addCategory()" class="btn btn-primary">Save
                                    changes</button>
                            </div>
                        </form>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editModal<?= $category['categoryID'] ?>">Edit</button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal<?= $category['categoryID'] ?>">Delete</button>
                            </td>
                        </tr>
