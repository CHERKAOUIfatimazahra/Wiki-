            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    <?php foreach ($tags as $tag): ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editModal<?= $tag['tagID'] ?>">Edit</button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal<?= $tag['tagID'] ?>">Delete</button>
                            </td>
                        </tr>
                        <!-- Edit Modal -->
                        <div class="modal fade" id="editModal<?= $tag['tagID'] ?>" tabindex="-1"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-outline mb-2">
                                                ...
                                                <input type="text" id="tagName" name="tagName"
                                                    class="form-control form-control-lg" value="<?= $tag['tagName'] ?>">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <!-- Delete Modal -->
                        <div class="modal fade" id="deleteModal<?= $tag['tagID'] ?>" tabindex="-1"
